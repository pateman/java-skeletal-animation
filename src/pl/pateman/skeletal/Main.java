...
//                this.lowerBodyChannel.addBone("Bip01 Footsteps");
            ...
            final RagdollStructure ragdollStructure = new RagdollStructureBuilder(this.meshEntity.getMesh())
                    ...
                    .startLink(HEAD, CHEST)
                        .setMinLimit(-Utils.PI * 0.3f, -Utils.EPSILON, -Utils.PI * 0.3f)
                        .setMaxLimit(Utils.HALF_PI, Utils.EPSILON, Utils.PI * 0.3f).endLink()
                    .startLink(CHEST, LEFT_UPPER_ARM)
                        .setMinLimit(-Utils.PI * 0.8f, -Utils.EPSILON, -Utils.HALF_PI)
                        .setMaxLimit(Utils.PI * 0.8f, Utils.EPSILON, Utils.HALF_PI).endLink()
                    ...
                    .startLink(CHEST, LEFT_UPPER_LEG)
                        .setMinLimit(-Utils.HALF_PI * 0.5f, -Utils.EPSILON, -Utils.EPSILON)
