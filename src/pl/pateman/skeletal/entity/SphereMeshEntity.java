...
import static pl.pateman.skeletal.Utils.HALF_PI;
import static pl.pateman.skeletal.Utils.TWO_PI;
...
public class SphereMeshEntity extends MeshEntity {
    ...
    public SphereMeshEntity(float radius, int rings, int sectors) {
        this.radius = radius;
